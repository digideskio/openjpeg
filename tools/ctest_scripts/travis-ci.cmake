...
if ("$ENV{OPJ_BUILD_SHARED_LIBS}" STREQUAL "")
  set( CTEST_BUILD_SHARED_LIBS "ON")
else()
	set( CTEST_BUILD_SHARED_LIBS "$ENV{OPJ_BUILD_SHARED_LIBS}")
endif()
...
BUILD_SHARED_LIBS:STRING=${CTEST_BUILD_SHARED_LIBS}
...
if (NOT "$ENV{OPJ_CPACK_SYSTEM_NAME}" STREQUAL "")
    ...
    if (${CTEST_BUILD_SHARED_LIBS})
      set(CPACK_SYSTEM_NAME "shared-$ENV{OPJ_CPACK_SYSTEM_NAME}")
    else()
      set(CPACK_SYSTEM_NAME "static-$ENV{OPJ_CPACK_SYSTEM_NAME}")
    endif()

    set( CACHE_CONTENTS "
    ${CACHE_CONTENTS}

    CPACK_SYSTEM_NAME:STRING=${CPACK_SYSTEM_NAME}
    "
    )
endif()
